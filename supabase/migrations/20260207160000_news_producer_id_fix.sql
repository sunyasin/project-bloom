-- Исправление: для новостей производителя сохраняем producer_id = owner_id
...
-- Создаём функцию которая использует owner_id как producer_id
...
BEGIN
  ...
  VALUES (
    ...
    NEW.owner_id, -- Используем owner_id как producer_id для отслеживания
